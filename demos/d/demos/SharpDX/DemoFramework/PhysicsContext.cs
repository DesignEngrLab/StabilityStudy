...
namespace DemoFramework
{
    public class PhysicsContext : System.IDisposable
    {
        ...
        public virtual RigidBody LocalCreateRigidBody(float mass, BulletSharp.Math.Matrix startTransform, CollisionShape shape)
        {
        ...
        public virtual void ShootBox(Vector3 camPos, Vector3 destination)
        {
            ...
            body.LinearFactor = new BulletSharp.Math.Vector3(1, 1, 1);
            //body.Restitution = 1;
